...
-- Equation(s):
-- \inst4|inst~0_combout\ = \PB[0]~input_o\ $ (\sw[1]~input_o\ $ (\PB[1]~input_o\))
...
-- Equation(s):
-- \inst4|inst1~combout\ = \sw[1]~input_o\ $ (((!\PB[1]~input_o\) # (!\PB[0]~input_o\)))
...
\inst4|inst2\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst4|inst2~combout\ = \sw[1]~input_o\ $ (((\PB[0]~input_o\) # (\PB[1]~input_o\)))
